...
- User-facing: Yes - Developer-facing web auth interface (`IWebAuth`) with platform implementations for launching auth sessions, handling redirects, and managing credentials on client builds.
