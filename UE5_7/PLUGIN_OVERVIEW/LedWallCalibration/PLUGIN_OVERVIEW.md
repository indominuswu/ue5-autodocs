...
- User-facing: Yes - Editor details action and `FLedWallCalibration` helpers are used by VP teams to generate Aruco marker textures and calibration subpoints for LED wall setups.
