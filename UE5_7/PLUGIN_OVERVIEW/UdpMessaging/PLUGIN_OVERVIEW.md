...
- User-facing: No - Transport-layer plugin configured via project/ini settings (`UUdpMessagingSettings`); no gameplay/editor surface beyond messaging infrastructure.
...
- Role: Project Settings > Plugins > UDP Messaging binds, broadcasts, and tunnels traffic. Configurable via `DefaultEngine.ini` or the Project Settings UI.
- Key properties:
