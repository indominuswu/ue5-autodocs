...
- User-facing: Yes - Exposes OpenCV to projects via `UOpenCVBlueprintFunctionLibrary` nodes and C++ helpers so developers can use CV functionality in gameplay/tools.
