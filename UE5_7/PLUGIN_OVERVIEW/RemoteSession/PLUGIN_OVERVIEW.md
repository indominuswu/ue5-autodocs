...
- User-facing: Yes - Streaming/remote-control stack with host/client roles, data channels, and editor UI (`SRemoteSessionStream`) that users configure to mirror frames/input between UE instances.
