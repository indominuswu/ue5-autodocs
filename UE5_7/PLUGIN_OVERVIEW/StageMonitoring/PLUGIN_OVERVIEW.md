...
- User-facing: Yes - Stage monitoring framework with settings (`UStageMonitoringSettings`, `UStageMonitorEditorSettings`) and monitor/provider interfaces that VP teams configure to observe stage performance across machines.
