...
- User-facing: Yes - Editor source control provider with settings panel and Git workers for checkout/commit/history used directly in Content Browser/SCM UI.
