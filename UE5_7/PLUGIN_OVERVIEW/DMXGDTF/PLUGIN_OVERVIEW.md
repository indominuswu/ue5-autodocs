...
- User-facing: Yes - DMX users import `.gdtf` fixture definitions (via `DMXGDTF` runtime + editor factory) to populate DMX libraries instead of hand-authoring fixture data.
