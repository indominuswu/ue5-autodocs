...
- User-facing: Yes - Networking configuration option: `USteamNetDriver`/`USteamNetConnection` transport for teams choosing Steam IP networking instead of SteamSockets P2P.
