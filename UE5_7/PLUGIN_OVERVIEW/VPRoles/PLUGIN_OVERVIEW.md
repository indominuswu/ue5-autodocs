...
- User-facing: Yes - VP teams configure roles in the editor/command line and query `UVirtualProductionRolesSubsystem` to drive role-specific behavior across machines.
