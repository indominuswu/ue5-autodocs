...
- User-facing: Yes - Take Recorder UI/modules (`TakeRecorder`, track recorder sources, settings, `UTakesCoreBlueprintLibrary`) used by VP teams to record, organize, and play back takes.
