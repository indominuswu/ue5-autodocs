...
- User-facing: Yes - Insights extension adding Slate analyzers/providers and UI (timing tracks, frame schematic) that developers use to profile Slate performance in captured traces.
