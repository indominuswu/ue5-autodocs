...
- User-facing: No - Editor utility library consumed by other tools (e.g., Plugin Browser); exposes helper functions only to editor code/automation, not end-user workflows.
