...
- User-facing: Yes - Blueprint-accessible Reflex controls (`UReflexBlueprintLibrary`) letting developers toggle Reflex modes and read latency metrics at runtime.
