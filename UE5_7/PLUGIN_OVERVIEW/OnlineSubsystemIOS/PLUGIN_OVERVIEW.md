...
- User-facing: Yes - Game Center OSS provider; games call `IOnlineSubsystem::Get("IOS")` for identity, sessions, friends, achievements, cloud saves, and StoreKit purchases.
