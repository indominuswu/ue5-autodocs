...
- User-facing: Yes - Users build vehicles with runtime components (`UModularVehicleComponent`, `UVehicleSim*Component`) and configure setups via the uncooked-only editor utilities.
