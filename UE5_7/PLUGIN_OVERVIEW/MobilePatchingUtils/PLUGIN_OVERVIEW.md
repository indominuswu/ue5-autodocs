...
- User-facing: Yes - Blueprint API (`UMobilePatchingLibrary`, `UMobilePendingContent`, `UMobileInstalledContent`) lets users download, track, and mount mobile OTA content updates.
