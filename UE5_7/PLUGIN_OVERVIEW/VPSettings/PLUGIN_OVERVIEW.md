...
- User-facing: Yes - VP teams set project-wide metadata and virtual camera presets in `UVPSettings` and access them from Blueprint/C++ to standardize VCam defaults.
