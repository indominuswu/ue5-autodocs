...
- User-facing: Yes - Groom authors use the editor tool/Dataflow nodes and settings (`UHairCardGenerator*Settings`) to generate card meshes/textures from hair grooms.
