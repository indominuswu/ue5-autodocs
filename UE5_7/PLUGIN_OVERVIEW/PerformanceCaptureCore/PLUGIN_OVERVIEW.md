...
- User-facing: Yes - Exposes `UPerformerComponent`/`URetargetComponent`/`URetargetAnimInstance` and editor customizations that capture teams use to bind Live Link subjects and retarget them to scene meshes.
