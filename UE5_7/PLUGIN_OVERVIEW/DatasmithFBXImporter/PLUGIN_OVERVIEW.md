...
- User-facing: Yes - Datasmith users enable this to import DeltaGen/VRED FBX exports and set import options (variants, materials, animations) in the import dialog.
