...
- User-facing: Yes - Blueprint library (`ULensDistortionBlueprintLibrary`) still exposes distortion/undistortion helpers for legacy projects, though deprecated in favor of CameraCalibration.
