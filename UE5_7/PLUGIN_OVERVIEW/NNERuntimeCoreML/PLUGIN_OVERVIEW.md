...
- User-facing: Yes - Developers import CoreML models through `UNNERuntimeCoreMLModelDataFactory` and target the CoreML runtime when wiring NNE inference on Apple platforms.
