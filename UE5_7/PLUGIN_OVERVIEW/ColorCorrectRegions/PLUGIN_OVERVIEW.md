...
- User-facing: Yes - Exposes `AColorCorrectRegion` actors that users place/tune in the editor for localized color grading; runtime `UColorCorrectRegionsSubsystem`/scene view extension applies those effects in play.
