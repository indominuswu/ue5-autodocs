# GeneSplicer Plugin v9.8.2 Plugin Overview
...
- User-facing: Yes - Ships Blueprint APIs (`UGeneSplicerBP::CreateGenePool/Splice`) and assets (`UGenePoolAsset`, `URegionAffiliationAsset`, import factories) for authoring and splicing facial animation data.

## 3. Key Modules

- **GeneSplicerLib** (Runtime)
- **GeneSplicerLibTest** (Runtime)
- **GeneSplicerModule** (Runtime)
