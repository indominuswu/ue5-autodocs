...
- User-facing: Yes - editor importer (`UAlembicImportFactory`, `UAlembicImportOptions`) used when bringing Alembic geometry/camera caches into the Content Browser.
