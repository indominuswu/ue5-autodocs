...
- User-facing: Yes - Provides IK retarget operators (`RelativeIKOp`, `BodyIntersectIKOp`) and editor helpers (`RelativeBodyAnimNotifies`, `RelativeBodyAnimModifier`) that animators use when setting up relative-body retargeting.
