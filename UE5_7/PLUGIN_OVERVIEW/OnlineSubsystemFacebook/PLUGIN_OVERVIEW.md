...
- User-facing: Yes - Facebook platform OSS provider exposing identity/friends/sharing/external UI via `IOnlineSubsystem::Get("FACEBOOK")` for games that integrate Facebook services.
