...
- User-facing: Yes - Motion Design users gain a Storm Sync provider (`FStormSyncAvaSyncProvider`, rundown extender) to push/pull Avalanche assets through Storm Sync from the editor UI.
