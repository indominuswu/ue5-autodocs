...
- User-facing: Yes - AnimNext motion-matching integration with traits (`FMotionMatchingTrait`, history collectors), RigVM utilities, and authoring templates for Pose Search-driven graphs.
