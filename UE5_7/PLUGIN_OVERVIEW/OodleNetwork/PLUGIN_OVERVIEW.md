...
- User-facing: Yes - Developers enable/customize Oodle net compression and run `UOodleNetworkTrainerCommandlet` to generate title-specific dictionaries for their multiplayer traffic.
