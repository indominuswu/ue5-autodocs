...
- User-facing: Yes - Gameplay teams configure surface effect rules/data tables and call `USurfaceEffectsSubsystem::GetSurface` at runtime to map physical surfaces to game-specific enums.
