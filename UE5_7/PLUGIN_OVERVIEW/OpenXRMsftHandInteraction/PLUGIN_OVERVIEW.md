...
- User-facing: Yes - Lets developers target the Microsoft hand interaction profile so hand tracking drives standard motion-controller inputs via OpenXR action bindings.
