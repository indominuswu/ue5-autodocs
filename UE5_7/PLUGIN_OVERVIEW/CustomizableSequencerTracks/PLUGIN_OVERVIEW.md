...
- User-facing: Yes - Experimental runtime/editor combo letting users author Sequencer tracks/sections in Blueprint (`USequencerTrackBP`, `USequencerSectionBP`) and register them in the Sequencer UI.
