...
- User-facing: Yes - Runtime-focused; users spawn `ADatasmithRuntimeActor` and call `UDatasmithRuntimeBlueprintLibrary` to load Datasmith files/Direct Link streams in-game.
