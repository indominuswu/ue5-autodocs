...
- User-facing: Yes - Datasmith users enable this to import CAD formats (.wire/.3dm/PLMXML) through the Datasmith import UI and tweak CAD tessellation/unit options.
