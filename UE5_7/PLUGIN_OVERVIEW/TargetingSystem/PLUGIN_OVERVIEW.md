...
- User-facing: Yes - Gameplay-facing targeting framework with presets, selection/filter/sort tasks, and Blueprint/ability tasks (`AsyncAction_PerformTargeting`, `AbilityTask_PerformTargeting`) used to drive targeting flows.
