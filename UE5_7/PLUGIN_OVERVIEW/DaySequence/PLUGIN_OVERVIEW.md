...
- User-facing: Yes - Users create Day Sequence assets, edit them with the Day Sequence editor toolkit, and place `ADaySequenceActor`/modifier components to drive time-of-day sequences.
