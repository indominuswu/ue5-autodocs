...
- User-facing: Yes - Remote Control protocol exposing MIDI device selection (project settings and editor customizations) so users can bind MIDI messages to exposed entities.
