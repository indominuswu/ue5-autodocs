...
- User-facing: Yes - Selected by games that want EOS Game Services through the OSSv2 API surface (auth/sessions/lobbies/achievements/files/etc. via `OnlineServicesEOSGS` components).
