...
- User-facing: No - Hidden `EditorAndProgram` core for synchronized tracing (ProgramAllowList for MultiUser/Insights tools); only supplies protocol/logic to client/server plugins, no user-facing UI or gameplay APIs.
