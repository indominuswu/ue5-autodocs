...
- User-facing: Yes - LiveLink panel source factory (`ULiveLinkFreeDSourceFactory`/UI) lets users configure FreeD connections and stream tracking data into LiveLink.
