...
- User-facing: Yes - Users create and edit Outfit Assets via editor factories/asset definitions and assemble outfits with runtime dataflow nodes for cloth parts and sizing.
