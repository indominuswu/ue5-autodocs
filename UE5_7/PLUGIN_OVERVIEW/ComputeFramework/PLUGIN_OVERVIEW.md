...
- User-facing: Yes - Users author compute graph assets (including “from text”) and attach `UComputeGraphComponent`/data interfaces to run their own GPU kernels in runtime scenes.
