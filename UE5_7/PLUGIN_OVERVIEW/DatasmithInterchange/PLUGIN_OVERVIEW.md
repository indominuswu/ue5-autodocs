...
- User-facing: Yes - Users select these Datasmith pipelines/material selectors when importing Datasmith payloads through Interchange to preserve lights/materials.
