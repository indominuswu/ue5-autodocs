...
- User-facing: Yes - Blueprint library (`USkeletalMergingLibrary` with `FSkeletalMeshMergeParams`/`FSkeletonMergeParams`) that users call to merge skeletal meshes/skeletons at runtime.
