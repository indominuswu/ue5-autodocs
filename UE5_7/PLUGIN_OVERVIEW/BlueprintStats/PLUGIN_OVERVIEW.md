...
- User-facing: Yes - Editor module registers `DumpBlueprintStats` console command and `IBlueprintStatsModule` APIs to let developers collect Blueprint usage metrics for their projects.
