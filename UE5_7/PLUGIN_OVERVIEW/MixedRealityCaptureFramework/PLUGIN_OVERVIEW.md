...
- User-facing: Yes - Users add `AMixedRealityCaptureActor`/`UMixedRealityCaptureComponent`, configure `UMrcFrameworkSettings`, and use `UMrcUtilLibrary` nodes for device selection/calibration and garbage matte capture.
