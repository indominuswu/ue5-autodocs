...
- User-facing: Yes - Blueprint utility (`USunPositionFunctionLibrary::GetSunPosition`) and placement helpers that users employ to drive sun/sky based on real-world location/time.
