...
- User-facing: Yes - Metasound authors enable this to try experimental nodes (channel/format-agnostic types, mapping function nodes) in the Metasound editor/runtime.
