...
- User-facing: Yes - Editor Plugins window and creation wizard (`FPluginBrowserModule`, `SPluginBrowser`, wizard definitions) that users open to manage and author plugins.
