...
- User-facing: Yes - AR provider with project settings (`UAppleARKitSettings`) and LiveLink integration used by AR developers through Unreal’s AR/Blueprint APIs.
