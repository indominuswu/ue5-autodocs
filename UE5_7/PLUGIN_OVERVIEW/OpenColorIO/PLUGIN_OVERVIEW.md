...
- User-facing: Yes - Exposes OCIO assets and Blueprint APIs (`UOpenColorIOConfiguration`, `UOpenColorIOBlueprintLibrary`, `UOpenColorIODisplayExtensionWrapper`) that artists use to configure and apply color management in editor/runtime.
