...
- User-facing: Yes - Runtime bundle manager API (`FDefaultInstallBundleManager` and platform sources) that developers use to download/mount install bundles in games.
