...
- User-facing: Yes - Developer-facing online API surface (`IOnlineSubsystem` feature interfaces for sessions/identity/friends/commerce/etc.) that games call directly or implement for new providers.
